...
### [Sean Metcalf — ADSecurity.org & Trimarc Security](https://adsecurity.org)
> **Note:** Sean Metcalf (@PyroTek3) is one of the most respected voices in Active Directory security. He is one of only about 100 people worldwide who hold the **Microsoft Certified Master (MCM) Directory Services** certification — an elite, invite-only credential that Microsoft retired in 2013. He is a former **Microsoft MVP**, has presented at Black Hat, DEF CON, BlueHat, RSA, Troopers, and BSides, and is co-host of the Enterprise Security Weekly podcast. Founder of Trimarc Security, now Identity Security Architect at TrustedSec. Follow him on [X/Twitter @PyroTek3](https://x.com/PyroTek3). [Trimarc Security](https://www.trimarcsecurity.com)** is Sean's consulting company performing work on behalf of TrustedSec.

**[ADSecurity.org](https://adsecurity.org)** is the definitive reference for Active Directory attack and defense. When mimikatz exposed DCSync, Golden Tickets, and Kerberoasting to the world, ADSecurity.org was where sysadmins went to understand what these attacks meant and how to stop them <kcite></kcite>. The site covers AD architecture, Kerberos internals, attack methods, detection strategies, and hardening guidance — all written with the depth of someone who has personally assessed some of the largest, most complex AD environments in the world. If you've ever Googled "how does DCSync work" or "Kerberos Golden Ticket detection," you've landed on his work.
...
Take potentially dangerous PDFs, Office documents, or images and convert them into safe PDFs. Originally created by Micah Lee at First Look Media, now maintained by the Freedom of the Press Foundation. Works like a photocopier — it renders your document into raw pixels inside a gVisor sandbox, then reconstructs a clean PDF from those pixels outside the sandbox, stripping any embedded malware or macros. Open-source (AGPLv3).
